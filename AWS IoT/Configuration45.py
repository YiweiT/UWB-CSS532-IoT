...
TOPIC_PUBLISH = "topic/test/toiot/historical_weather"
TOPIC_SUBSCRIBE = "topic/todevice/usercommand/weather"
...
def on_message_received(topic, payload, dup, qos, retain, **kwargs):
    ...
    data = payload.decode('utf8').replace("'", '"')
...
def publish(topic_publish, message):
    ...
    print("Published to the topic: " + topic_publish)
    time.sleep(1)
    print('Publish End')
